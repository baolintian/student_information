...
<div class="bbk" style="height:900px; width:70%; top:50px; left: 520px;" >
    ...
    <form action="../back/updateclass.php" method = "post">
        <div style="font-size: 30px; font-family: 'Adobe 楷体 Std R'">旧班号:
            <input type = "text" name = "oldclass">
        </div style="font-size: 30px; font-family: 'Adobe 楷体 Std R'">
        <div style="font-size: 30px; font-family: 'Adobe 楷体 Std R'">新班号:
