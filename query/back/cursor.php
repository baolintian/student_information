...
<div class="bbk" style="height:900px; width:70%; top:50px; left: 520px;" >
    ...
    <form action="../back/cursor.php" method = "post">
        <input type = "submit" value ="检测开始">
    </form>
    ...
    if($result instanceof mysqli_result){
        echo "The numbers between them are different", "<br/>";
        echo '<center><table class="imagetable">
            <tr>
                <th>系号</th><th>系名</th><th>原来人数</th><th>实际人数</th>
            </tr>';
        while($row = $result->fetch_object()){
            echo '<tr>
                <td>', $row->deptno, '</td><td>', $row->deptname, '</td><td>', $row->old_num, '</td><td>', $row->real_num, '</td>
            </tr>';
        }
        echo '</center>';
    }
